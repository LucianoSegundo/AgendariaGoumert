...
public class Fachada {
	...
	private Repositorio<Contato, Long> contaRepo;
...
// Inserir
		...
		try {
			...
			erro.setStackTrace(e.getStackTrace());  throw erro;
		}
	}
...
// ler
		...
		public Contato lerContato(String  nome) {
			try {
				...
				ErroDeInsercaoException erro = new ErroDeInsercaoException("não foi possivel ler o contato pelo nome do contato");
		...
		public List<Email> listarEmail(long  idContato) {
			try {
				...
				ErroDeInsercaoException erro = new ErroDeInsercaoException("não foi possivel ler o telefone pelo id do contato");
