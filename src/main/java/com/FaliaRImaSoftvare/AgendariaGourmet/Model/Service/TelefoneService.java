...
public class TelefoneService {
	...
	public void criar(Long id, TelefoneDTO telefone) {
		if(id == null) throw new CamposInvalidosException("Id do contato invalido, não foi possivel criar contato");
	...
	public void alterar(Long idtelefone, TelefoneDTO telefone) {
		if(idtelefone == null) throw new CamposInvalidosException("Id do telefone invalido, não foi possivel alterar o telefone");
	...
	public void excluir(Long id) {
		if(id == null) throw new CamposInvalidosException("Id do telefone invalido, não foi possivel excluir telefone");
